...
const CopyRowsModal = ({ selectedRows, user, open = false, handleClose = () => { } }) => {
    ...
    const handleCopyRows = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        <>
            ...
            >
                <Box sx={style}>
                    ...
                    <Box component="form" onSubmit={handleCopyRows} sx={{ mt: 1 }} >
